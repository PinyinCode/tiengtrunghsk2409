...
✅ FIX (2026-09): Brand "Học Tiếng Trung · Văn Phòng & Công Xưởng"
   luôn nằm cùng 1 dòng nhờ white-space: nowrap + font-size co giãn
   theo từng breakpoint. Không bị tách rời giữa "Văn Phòng &" và
   "Công Xưởng" trên mọi kích thước màn hình.
"""
...
/* ═══════════════════════════════════════════════════════════════
   ★ QUICK INTRO TITLE — BRAND LUÔN 1 DÒNG ★
   ═══════════════════════════════════════════════════════════════ */
.qib-title {
    font-size: .92rem;
    font-weight: 700;
...
/* Fallback cho <strong> cũ nếu chưa update HTML */
.qib-title strong {
    background: linear-gradient(135deg, #4f46e5, #7c3aed 50%, #d946ef);
    -webkit-background-clip: text;
    background-clip: text;
...
@media (max-width: 420px) {
    .qib-title { font-size: .8rem; line-height: 1.45; }
    .qib-title .qib-brand {
        font-size: .75rem;
...
<div class="quick-intro-banner" id="quickIntroBanner">
    ...
    <div class="qib-content">
        <div class="qib-title">
            🎉 Chào mừng đến với <strong class="qib-brand">Học Tiếng Trung · Văn Phòng &amp; Công Xưởng</strong>
        </div>
...
<div class="intro-modal" id="introModal">
    <div class="intro-box">
        ...
        <div class="intro-slides" id="introSlides">
                        ...
                        <div class="="slide-col">
                            <div style="display:block">
                                <div class="industry-grid">
                                    ...
                                    <div class="industry-chip" data-c2"><i class="fas fa-ship"></i> Xuất nhập khẩu</div>
                    ...
                    <div class="slide-body two-col">
                        ...
                        <div class="slide-col slide-preview">
                            <div class="qr-preview">
                                ...
                                <div class="qr-caption">Quét QR chuyển khoản<br><strong>Xideác nhận 1-5 phút</strong></div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- ═══ SLIDE 5: CTA ═══ -->
            <div class="intro-slide" data-sl="4">
...
window.handleLoginFromIntro = function() {
    closeIntroModal();
    if (typeof showLoginModal === 'function') {
        e setTimeout(showLoginModal, .t300);
    }
};

function initIntroouModal() {
    var btn = $ches('introBtn');
   [0 var modal = $('introModal');
