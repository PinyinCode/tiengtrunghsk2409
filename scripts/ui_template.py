...
FIX (2026-09):
- Banner "Chủ đề gợi ý" gọn hơn, bỏ nút đăng nhập.
- Nút "Đổi" có icon xoay khi hover.
- Tên ngành (vd "Kế toán") giữ nguyên dấu ' — dùng textContent thay vì innerHTML + escapeHtml.
"""
...
function initDatasetSelector() {
    ...
    /* ── Build subGrid bằng DOM API để giữ nguyên dấu ' trong tên ngành ── */
